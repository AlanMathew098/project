...
<div class="container my-5">
    <div class="row">
      <div class="col-md-6">
        <img src="./admin/alan/<?php echo $row["product_image"];?>" class=""  width="" alt="" />
      </div>
      <div class="col-md-6">
    <h2 class="" style="font-weight: 600;"><?php echo $row["product_name"];?></a>
    </h2>
    <p class=""> Price:$<?php echo $row["product_price"];?></a></p>
    <span class="fa fa-star checked"></span>
    <span class="fa fa-star checked"></span>
    <span class="fa fa-star checked"></span>
    <p class=" "> <?php echo $row["product_details"];?></a></p>
