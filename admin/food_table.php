						...
						<ul>
							...
							<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Products </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_class" style="display: none;">
									...
									<li><a href="food_add.php"> Add Hot Coffee </a></li>
							...
							<li class="submenu"> <a href="#"><i class="fas fa-table"></i> <span> Tables </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_class" style="display: none;">
									<li><a href="food_table.php">Product Table </a></li>
...
<div class="row">
  ...
  <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="food_edit.php?sa=<?php echo $row["id"];?>"  ><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a  class="dropdown-item" href="" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
</div>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-body text-center"> <img src="assets/img/sent.png" alt="" width="50" height="46">
			...
			<a href="food_delete.php?sa=<?php echo $id;?>"> <button type="submit" class="btn btn-danger">Delete</button></a>
            </div>
        </div>
    </div>
</div>
