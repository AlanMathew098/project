		...
		<div class="main-wrapper">
			<div class="header">
				<div class="header-left">
					<a href="index1.php" class="logo"> <img src="./assets/img/cax.pm=ng" width="50" height="70" alt="logo"> <span class="logoclass"></span> </a>
						...
						<ul>
							...
							<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Products </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_class" style="display: none;">
									<li><a href="edit-booking.php"> Edit Products </a></li>
					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
                                ...
                                <a href="add-booking.html" class="btn btn-primary float-right veiwbutton ">Add Products</a>
                            </div>
						</div>
					</div>
				</div>
