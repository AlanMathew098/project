...
<div class="row">
                    ...
                    <table class="datatable table table-stripped table table-hover table-center mb-0">
						...
						<tbody>
							...
							<td align="left"><?php echo $row['product_id'];?></td>
						        ...
						        <td align="left"><?php echo $row['product_type'];?></td>
  ...
  <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="edit-booking.php?sa=<?php echo $row["id"];?>" ><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a  class="dropdown-item" href="delete.php" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
</div>
