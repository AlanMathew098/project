						...
						<ul>
							...
							<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Products </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_class" style="display: none;">
									...
									<li><a href="add-booking.php"> Add Products </a></li>
									<li><a href="add hot.php"> Add Hot Coffee </a></li>
								</ul>
							...
							<li class="submenu"> <a href="#"><i class="fas fa-table"></i> <span> Tables </span> <span class="menu-arrow"></span></a>
								<ul class="submenu_class" style="display: none;">
									<li><a href="tables-basic.php">Product Table </a></li>
			...
			<div class="row formtype ">
				<div class="col-md-6 my-5">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="product_id" value="<?php echo $row['product_id'];?>" >
					 </div>
					 </div>
						<div class="col-md-6 my-5">
							<div class="form-group">
								<label>Product Name</label>
								<input class="form-control" id="sel1" name="product_name"value="<?php echo $row['product_name'];?>" >
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="number" id="sel1" name="product_price"value="<?php echo $row['product_price'];?>">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" type="text" value="<?php echo $row['product_type'];?>" id="sel2" name="product_type">
