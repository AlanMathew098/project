...
<section>
    <div class="container-">
        <div class="pics">
            <img src="./images/sun.jpg" class="font"  width="" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="row">
      <div class="col-md-6">
        <form class="clearfix searchform">
            ...
            <input type="search" id="search-box" placeholder="Find a store" />
          </form>
          <button type="button" class="btn btn-outline-secondary  img-fluid zt ">Fliter Now </button>
           <div class="max">
           ...
           <button type="button" class="btn  img-fluid xt text-white " style="background-color:#522e08 ;">Order now</button>
      </div>
      <div class="col-md-6 my-4">
        <div class="mapouter img-fluid"><div class="gmap_canvas"><iframe class="gmap_iframe" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=University of Oxford&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://piratebay-proxys.com/">Pirate bay</a></div><style>.mapouter{position:relative;text-align:right;width:600px;height:400px;}.gmap_canvas {overflow:hidden;background:none!important;width:600px;height:400px;}.gmap_iframe {width:600px!important;height:400px!important;}</style></div></div>
